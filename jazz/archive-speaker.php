...
<section class="bg_footer top">
  <div class="home_participants page_members">
    <h2>
      <?php
        if($lang == 'ru'){
          echo 'Участники';
    ...
    <div class="">
      <div class="container">
        <div class="participants_box members_box">
          ...
          <div class="participants_box__cart members_cart">
        ...
        <div class="participants_cart_show-more btn_jazz more_members">
          <a href="#">
              <?php 
                if($lang == 'ru'){
                  echo 'Смотреть еще';
